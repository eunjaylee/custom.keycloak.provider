...
public class AppleIdentityProvider extends AppleOIDCIdentityProvider implements SocialIdentityProvider<OIDCIdentityProviderConfig> {
...
//        federatedIdentity.setIdpConfig();
    ...
    private BrokeredIdentityContext handleUserJson(BrokeredIdentityContext context, String userJson) {
        try {
            logger.debugf("apple broker json = %s", userJson);
