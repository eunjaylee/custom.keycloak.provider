...
//            adapter = new KbookUserAdapter(session, realm, model, result.get(0));
...
//    public String getChangePwdDay(RealmModel realm, String id) {
//        TypedQuery<String> query = em.createNamedQuery("searchChangePwdDay", String.class);
...
//        KbookUserEntity entity = new KbookUserEntity();
//        entity.setId(UUID.randomUUID().toString());
//        entity.setUsername(username);
//        em.persist(entity);
//        logger.info("added user: " + username);
//        return new KbookUserAdapter(session, realm, model, entity);
//    }
//
//    @Override
//    public boolean removeUser(RealmModel realm, UserModel user) {
//        String persistenceId = StorageId.externalId(user.getId());
//        KbookUserEntity entity = em.find(KbookUserEntity.class, persistenceId);
...
//        String password = ((KbookUserAdapter)delegate).getPassword();
//        if (password != null) {
...
//        KbookUserAdapter adapter = getUserAdapter(user);
...
//    }
    ...
    public boolean isValid(RealmModel realm, UserModel user, CredentialInput input) {
        if (!supportsCredentialType(input.getType()) || !(input instanceof UserCredentialModel)) return false;
        UserCredentialModel cred = (UserCredentialModel)input;
        return passwordCheck(getPassword(user), cred.getValue() , user.getId());
    }
    ...
    private boolean passwordCheck(String dbPwd, String inputPwd, String id) {
        try {
            PasswordEncoder encoder = passwordEncoder();
            String encPassWordsha = encoder.encode(inputPwd);
            if (encPassWordsha.equals(dbPwd)) return true;
        } catch(Exception e) {
            logger.error("pwd error : ", e);
        }
        return false;
    }
